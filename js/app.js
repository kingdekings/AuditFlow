document.addEventListener('DOMContentLoaded', () => {
  ...
  const samples = {
    reportTitle: "Informe ejecutivo semanal",
    reportDate: "28 de agosto de 2026",
    reportNumber: "Informe No. 034",
    processes: "Contratación y compras\nSupervisión operativa\nGestión documental",
    directors: "Dirección de Operaciones\nDirección Administrativa",
  ...
  function syncField(inputId, previewId) {
    ...
    if (previewEl) previewEl.textContent = value(inputId);
  }
  ...
  // 2. Quitamos el input de subtitulo
  ...
  // 3. Quitamos el elemento <p> del subtítulo en la vista previa
  ...
  document.getElementById("fontChoice").addEventListener("change", event => setReportVar("--report-font", event.target.value));
  ...
  // 4. Se eliminó la captura del data-aspect-subtitle
  ...
  // 5. El nuevo aspecto solo empuja título
  ...
  // 6. Cargar ejemplo ahora incluye los aspectos sin subtítulo
  ...
  setPageBackgroundStyle("bg-geometric-blocks");

  // 7. Modificación para desactivar el select cuando se sube imagen
  function applyCustomBackground(src) {
    ...
    // Desactivar selector y quitar clase de fondo actual para evitar cruces
    if (bgStyleSelect) {
